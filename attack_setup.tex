...
\noindent \textbf{Remark.} To date (kernel 5.3), the \texttt{spb2\_management\_orb} struct has not changed since \textcolor{red}{kernel 4.15 - Dude it was vulnerable before as well...}.