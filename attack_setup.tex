...
In our attacks, we use an Intel x86 machine with Ubuntu 17.10 (kernel version 4.13), as our victim machine. The server is equipped with Intel VT-d IOMMU and a Broadcom NetXtreme II BCM5709 Gigabit Ethernet NIC. An identical machine connected to the victim with a FireWire cable acting as the attacker. 
