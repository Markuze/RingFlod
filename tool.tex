...
[1]CALL[fc_dma_map_single:939]: return dev ? dma_map_single(dev, ptr, size, dir) : (dma_addr_t)0L;
                ...
                \end{lstlisting}
\end{adjustbox}
        \caption{ Tool output example.\SV{the example looks ``heavy''... do we need all lines and all details?... also, you must increase the size of the captions... also added ``adjustbox'' for listings...}}
