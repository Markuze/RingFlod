...
The output starts from the impact evaluation,  such as detected exposed callback pointers, and continues with pertinent code lines. %\sout{Starred lines contain script analysis}.
...
This example demonstrates the recursive nature of the analysis.
