...
Aided by the output of the tools, we demonstrate novel attacks on the Linux kernel.
We first introduce \emph{single-step} attacks, where the MMO trifecta is trivially provided and show that previously reported attacks fall into this category. Then, we present a new type of \compound{} attacks where the trifecta of vulnerability attributes is initially incomplete but can be attained by carefully exploiting standard OS behavior.
