...
We first discuss \emph{single-step} attacks and show that previously reported attacks fall into this category. Then, we present a new type of \compound{} attacks where the trifecta of vulnerability attributes is initially incomplete but can be attained by carefully exploiting standard OS behavior.
