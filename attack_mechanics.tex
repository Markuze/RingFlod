...
In this section, we introduce the MMO (\motivation, \means, \oportunity) schema. Using this schema, we can better understand the DMA vulnerabilities of an OS, the viability of possible DMA attacks, and their prevention. 
