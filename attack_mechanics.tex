...
Under the hypothesized circumstance, and without additional information, a malicious device has practically no \sout{valid}\textcolor{red}{viable} attack options.
