...
In particular, the Linux kernel has predetermined ranges for its virtual memory layout~\cite{mem_layout}. This layout defines the location of the kernel text mapping, the direct mapping of physical memory and the virtual memory~\ref{fig:mem_layot}. KASLR randomizes the offset of these segments in the corresponding range on each boot.
