...
\adam{why is this in the background section??? it is part of the results. not to mention it uses concepts that weren't really defined yet (single-step, compound). It should go at the end of Section 4 IMO. But make sure the concepts of single-step and compound are formally defined BEFORE this section}
