...
%DIF DEL ../orig/main.tex   Tue Mar 23 15:05:39 2021
%DIF ADD main.tex           Mon Mar 22 18:38:48 2021
...
Direct \DIFdelbegin \DIFdel{Memory Access }\DIFdelend \DIFaddbegin \DIFadd{memory access }\DIFaddend (DMA) \DIFdelbegin \DIFdel{makes the }\DIFdelend \DIFaddbegin \DIFadd{renders a }\DIFaddend system vulnerable to DMA attacks, in which I/O devices access memory regions not intended for their use. Hardware \DIFdelbegin \DIFdel{IOMMU protection }\DIFdelend \DIFaddbegin \DIFadd{input–output memory management units (IOMMU) 
%DIF > connect a direct-memory-access–capable  I/O bus to the main memory and 
can be used to provide protection; however, they }\DIFaddend cannot prevent all DMA attacks because \DIFdelbegin \DIFdel{it }\DIFdelend \DIFaddbegin \DIFadd{IOMMU only }\DIFaddend restricts DMA at page-level granularity\DIFaddbegin \DIFadd{, }\DIFaddend leading to \subpage vulnerabilities. 
...
To this end, we first categorize \subpage vulnerabilities into four \DIFdelbegin \DIFdel{categories}\DIFdelend \DIFaddbegin \DIFadd{types}\DIFaddend , providing insight into the structure of DMA vulnerabilities. 
...
\DIFdelbegin \DIFdel{Finally, our code is }\DIFdelend \DIFaddbegin \DIFadd{Our tools are }\DIFaddend publicly available \cite{DKASAN,SPADE}.
