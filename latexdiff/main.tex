...
%DIF DEL main.tex                 Mon Mar 15 13:18:48 2021
%DIF ADD ../ReviewEU21/main.tex   Sun Mar 21 11:38:28 2021
...
\DIFdelbegin \DIFdel{We find }\DIFdelend \DIFaddbegin \DIFadd{Using these tools, we found }\DIFaddend that 72\% of the device drivers expose sensitive callback pointers, which may be overwritten by a device to hijack \DIFaddbegin \DIFadd{the }\DIFaddend kernel control flow.
...
\DIFdelbegin \DIFdel{Finally, our }\DIFdelend \DIFaddbegin \DIFadd{Our }\DIFaddend code is publicly available \cite{DKASAN,SPADE}.
