...
Accordingly, in Sec. \ref{sec:api}, we provide examples of such OS design choices and summarize APIs we have exploited for executing \compound{} DMA attacks\DIFdelbegin \DIFdel{. Finally, }\DIFdelend \DIFaddbegin \DIFadd{, %DIF > In Sec. \ref{sec:rand_exp} we discuss random exposure vulnerabilities.
then, }\DIFaddend in Sec. \ref{sec:Conclusion} we conclude the paper.
