...
\smallskip
\noindent\textbf{Windows.} Until recently (2019) Windows had no IOMMU support, exposing it to \simple DMA \DIFdelbegin \DIFdel{attack}\DIFdelend \DIFaddbegin \DIFadd{attacks}\DIFaddend .
In 2019 (with build 1803) Microsoft \DIFdelbegin \DIFdel{has }\DIFdelend introduced Kernel DMA Protection \cite{ms_iommu}, which provides IOMMU protection by default with a dedicated I/O page table per device. 
