...
\begin{enumerate}
    ...
    The device will retain access to the physical page as long as a single valid \iova{} exists. This means that the device can \DIFdelbegin \DIFdel{temper }\DIFdelend \DIFaddbegin \DIFadd{tamper }\DIFaddend with memory regions that should no longer be accessible to it. We discuss the practical implications of multiple \iova indicating the same page in Sec.~\ref{sec:timely}.
...
Namely, all three attributes are required for a code injection attack.
