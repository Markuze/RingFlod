...
\DIFdel{buffer of the }\DIFdelend \DIFaddbegin \DIFadd{The payload in the }\DIFaddend \skb{} \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{can be partially located on }\DIFaddend the \emph{linear} part\DIFdelbegin \DIFdel{of the payload but }%DIFDELCMD < \skb{} %%%
