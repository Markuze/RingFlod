...
Accordingly, in Sec. \ref{sec:api}, we provide examples of such OS design choices and summarize APIs we have exploited for executing \compound{} DMA attacks. Finally, in Sec. \ref{sec:Conclusion} we conclude the paper.
