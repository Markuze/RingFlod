...
\textcolor{violet}{Recall that, once we have discovered a \subpage{} vulnerability, our goal is to obtain the tree vulnerability attributes (Sec. \ref{sec:mmo}: (1) a KVA, (2) a callback pointer and, (3) timing). 
